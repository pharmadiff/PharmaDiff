...
from pharmadiff.datasets.dataset_utils import mol_to_torch_geometric, remove_hydrogens, Statistics
from pharmadiff.datasets.dataset_utils import load_pickle, save_pickle
from pharmadiff.datasets.abstract_dataset import AbstractDatasetInfos, AbstractDataModule, AbstractAdaptiveDataModule
    ...
    def processed_file_names(self):
        ...
        if self.split == 'train':
            return [f'train_{h}.pt', f'train_n_{h}.pickle', f'train_atom_types_{h}.npy', f'train_bond_types_{h}.npy',
                    ...
                    f'train_angles_{h}.npy', 'train_smiles.pickle', 'qm9_train_smiles_noh.pickle']
        elif self.split == 'val':
            return [f'val_{h}.pt', f'val_n_{h}.pickle', f'val_atom_types_{h}.npy', f'val_bond_types_{h}.npy',
                    ...
                    f'val_angles_{h}.npy', 'val_smiles.pickle', 'qm9_val_smiles_noh.pickle']
        else:
            return [f'test_{h}.pt', f'test_n_{h}.pickle', f'test_atom_types_{h}.npy', f'test_bond_types_{h}.npy',
                    ...
                    f'test_angles_{h}.npy', 'test_smiles.pickle', 'qm9_test_smiles_noh.pickle']
    ...
    def process(self):
        ...
        for i, mol in enumerate(tqdm(suppl)):
            ...
            if pharmacophore is None:
                continue
            if self.remove_h:
                data, pharmacophore = remove_hydrogens(data, pharmacophore)
        ...
        torch.save(self.custome_collate(self, data_list), self.processed_paths[self.file_idx])

        statistics = compute_all_statistics(mols_list, self.atom_encoder, charges_dic={-1: 0, 0: 1, 1: 2})
...
class QM9infos(AbstractDatasetInfos):
    ...
    def to_one_hot(self, X, charges, E, node_mask):
        ...
        pl = placeholder.mask(node_mask=node_mask)
    ...
    def pharma_to_one_hot(self, X,pharma_mask):
        ...
        placeholder = PlaceHolder(X=None, charges=None, E=None,  y=None, pos=None, pharma_coord=None, 
                                  pharma_feat=X, pharma_atom=None)
        #pl = placeholder.mask()
