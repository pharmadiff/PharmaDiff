...
import torch
from pharmadiff.datasets.adaptive_loader import AdaptiveDataLoader, AdaptiveLightningDataset
try:
    from torch_geometric.data import LightningDataset
except ImportError:
    from torch_geometric.data.lightning import LightningDataset
from pharmadiff.diffusion.distributions import DistributionNodes
...
def shuffle_data(inputs, labels):
    ...
    torch.random.shuffle(shuffled_dataset)
    
    # Unzip the shuffled dataset
    shuffled_inputs, shuffled_labels = zip(*shuffled_dataset)
...
def collate_fn(data):
    ...
    pharmacophore_batch = Batch.from_data_list(pharmacophores)
